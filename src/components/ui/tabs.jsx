...
const TabsTrigger = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "border-b-0 border-none hover:text-foreground/80",
      "data-[state=active]:bg-background data-[state=active]:text-orange-500",
      className,
    )}
    style={{
      borderBottom: "none",
  ...
  >
    ...
    <span
      className={cn(
        "absolute bottom-0 left-0 right-0 h-[2px] w-full bg-transparent",
